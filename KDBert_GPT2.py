...
def main():
    ...
    print("dataset is loaded successfully!", len(trainset))
    ...
    print("input_ids")
    iids = [example[0] for example in trainset]
    print("iids: ",len(iids), len(iids[0]))
    check_length = [len(i) for i in iids]
    print("check_length: ", set(check_length))
